          ...
          <div class="card-body bg-light">
            <form action="edit.php" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="tel" class="form-control" name="uphone" value="<?php echo $customer['phone']; ?>" required="">
              </div>
              <div class="form-group">
                <label for="bio">Bio:</label>
                <textarea class="form-control" name="ubio" value="<?php echo $customer['bio']; ?>" required=""></textarea>
              </div>
              <div class="form-group">
                <input type="hidden" name="id" value="<?php echo $customer['id']; ?>">
                <input type="submit" name="update" class="btn btn-danger" style="float:right;" value="Update">
              </div>
            </form>
          </div>
        </div>
